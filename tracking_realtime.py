...
VIDEO_1="/kaggle/input/test-video/cam1_short.mp4"
VIDEO_2="/kaggle/input/test-video/cam2_short.mp4"
        ...
        if not q0.empty() and not q1.empty():
            try:
                ...
                with open(SAVE_PATH, 'a') as f:
                    np.savetxt(f, frame_results_with_timestamp, fmt='%s %s %s %s %s %s %s %f %f %s')
